...
st.set_page_config(page_title="Automotive Vehicle Test Planning Tool for ITPL & VPM", layout="wide")
st.title("🧑‍🔧🛠️🚗 Automotive Vehicle Test Planning Tool for ITPL & VPM ")
